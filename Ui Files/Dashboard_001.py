...
"border:2px solid white;")
        ...
        self.image_for_detection.setGeometry(QtCore.QRect(260, 10, 511, 391))
        self.image_for_detection.setObjectName("image_for_detection")
        self.live_mode_2 = QtWidgets.QPushButton(self.detect_from_image)
        self.live_mode_2.setGeometry(QtCore.QRect(30, 170, 211, 51))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(16)
        font.setBold(True)
...
"background-color: rgb(0, 255, 0);")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../icons/broadcast.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.live_mode.setIcon(icon9)
...
"background-color: rgb(0, 255, 0);")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../icons/image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.detect_from_image_2.setIcon(icon10)
